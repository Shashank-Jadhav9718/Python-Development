# Refactor your BankAccount class to make the balance a private attribute. Then, create a secure "getter" method so users can view their balance without being able to modify it directly.
